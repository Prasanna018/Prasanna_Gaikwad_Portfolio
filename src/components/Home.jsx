...
const Home = () => {
  return (
    <section
      id="home"
      className="pt-[120px] min-h-screen flex flex-col lg:flex-row items-center justify-center px-6 lg:px-32 text-center lg:text-left gap-y-12 lg:gap-x-24"
    >
      {/* Full-Width Logo Image with Extra Spacing */}
      ...
      <div className="w-full lg:w-1/2 flex flex-col md:text-center items-center lg:items-start">
        <motion.div
